...
public class FindUtil_findOptionalInputStreamTest {
    ...
    public void input_empty() {
        final Executable testMethod = () -> this.cut.findOptionalInputStream();
    ...
    public void input_unknown() {
        final Optional<InputStream> actual = this.cut.findOptionalInputStream(
