...
public class FindUtil_findFirstFileAsOptionalFileTest {
    ...
    public void input_empty() {
        final Executable testMethod = () -> this.cut.findFirstFileAsOptionalFile();
    ...
    public void input_unknown() {
        final Optional<File> actual = this.cut.findFirstFileAsOptionalFile(
